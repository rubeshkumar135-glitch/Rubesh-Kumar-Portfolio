    ...
    <div className="navbar flex justify-between md:px10 px-5 py-4 items-center">
      ...
      <ul>
        ...
        <FaAlignJustify
          ...
          className="text-white right-5 absolute md:hidden flex text-lg mt-1 mr-3 cursor-pointer"
        />

        {button && (
          <div className="text-gray-50 text-xs md:hidden flex flex-col gap-4 mr-6 mt-8 absolute right-0 bg-gray-800/60 backdrop-blur-lg rounded-lg p-4 shadow-lg">
            <NavLink
              to="/"
